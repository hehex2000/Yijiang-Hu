...
from run_monthly_rebalance import (
    ...
    SLIPPAGE_RATE, INDEX_DISPLAY_NAME,
)
...
#  神奇公式选股
# ════════════════════════════════════════════════════════════
def select_magic_formula(rebalance_date, top_n=TOP_N, prev_date=None, verbose=True):
...
def run_backtest(start_date="20140101", end_date="20260715",
    ...
    for i, td in enumerate(trade_dates):
        ...
        if td in rebal_set and i > 0:
            ...
            sel = select_magic_formula(td, top_n=top_n, prev_date=prev_td, verbose=verbose)
...
if __name__ == "__main__":
    ...
    if args.select_year:
        ...
        if not rb:
            ...
            sel = select_magic_formula(td, top_n=args.top_n, prev_date=prev, verbose=True)
        ...
        run_backtest(args.start_date, args.end_date,
                     top_n=args.top_n, verbose=not args.quiet)
