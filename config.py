...
STRATEGIES = {
    ...
    "mean_reversion": {
        ...
        #  单笔投入占【当前权益】的比例。0.10 由 walk-forward 8/8 窗口三维度全胜得出
        #  （CAGR 13.95 / Sharpe 1.05 / MDD −19.29 vs f=0.20 的 9.20 / 0.63 / −31.59）。
        #  不声称是最优点：各窗口 CAGR 峰值 f 飘移 0.05~0.30，只是配对比较 8/8 全胜。
        "portfolio_f": 0.10,
