...
STRATEGIES = {
    ...
    "mean_reversion": {
        ...
        #     默认 False ⇒ 主流程零变更；这是引擎级切换，跑通确认后再谈改默认。
        "portfolio_shared_pool": False,
        #  单笔投入占【当前权益】的比例。
        #  None ⇒ **自动模式** f = clamp(2/N, 0.05, 0.30)，N = 实际股票只数。
        #    实证（run_small_capital_scan.py，zz800 / 20200103~20260825）：
        #      N=5 →0.30   N=10 →0.20   N=20 →0.10   N=40 →0.05   ⇒ f×N ≈ 2.0 恒定
